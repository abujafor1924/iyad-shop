...
const VewDetails = () => {
  ...
  const { category, image, name, price, description } = details;
  console.log(details);
  return (
    <div className="relative z-10 w-[100%]" role="dialog" aria-modal="true">
      <div className="fixed inset-0 hidde bg-opacity-75 transition-opacity md:block"></div>
          ...
          <div className="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
            <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
              ...
              <div className="grid w-full grid-cols-1 items-start gap-x-6  gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                <div className=" aspect-h-3 aspect-w-2 w-[100%] h-[100%] overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5">
                  <img
                    src={image}
                  ...
                  >
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <a
                          href="#"
                          className="ml-3 text-sm font-medium text-[#9F1239] hover:text-[#9d3251]"
                        >
                          117 reviews
                        </a>
                      </div>
                    ...
                    <form>
                      ...
                      <div className="mt-10">
                        <div className="flex items-center justify-between">
                          ...
                          <a
                            href="#"
                            className="text-sm font-medium text-[#9F1239] hover:text-[#3f1823]"
                          >
                            Size guide
                          </a>
                        </div>
                      ...
                      <button
                        type="submit"
                        className="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-[#9F1239] px-8 py-3 text-base font-medium text-white hover:bg-[#b11642] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                      >
                        Add to bag
                      </button>
                    </form>
